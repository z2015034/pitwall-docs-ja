...
| 項目                     | 説明                                                      |
| -                        | -                                                         |
|シナリオの新規作成        |このボタンをクリックすることで、新規シナリオ作成のページへ遷移します。作成方法については、「シナリオの新規作成」手順へ進みます。|
...
シナリオの三点リーダー![](../../.gitbook/assets/three_points_reader_icon.png)をクリックすることで、その他のメニューを表示します。
